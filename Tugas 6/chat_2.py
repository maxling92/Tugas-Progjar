...
class Chat:
	def __init__(self):
		...
		self.sessions={}
		self.users = {}
		self.users['james']={ 'nama': 'James Tralala', 'negara': 'Indonesia', 'password': 'medan', 'incoming' : {}, 'outgoing': {}}
		self.users['aldo']={ 'nama': 'Aldo Trapani', 'negara': 'Russia', 'password': 'moskow', 'incoming': {}, 'outgoing': {}}
		self.users['kendo']={ 'nama': 'Kendo Suzuki', 'negara': 'Jepang', 'password': 'tokyo','incoming': {}, 'outgoing':{}}
